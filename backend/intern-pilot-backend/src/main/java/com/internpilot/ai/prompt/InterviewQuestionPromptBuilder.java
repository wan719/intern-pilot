...
public class InterviewQuestionPromptBuilder {
    ...
    public static String build(
        ...
        prompt.append("你是一个资Java 后端面试官、技术招聘官和大学生实习求职导师。\n\n");
        prompt.append("请根据下面的【学生简历文本】、【目标岗JD】和【AI 匹配分析报告】，为该学生生成一套适合该岗位的实习面试准备题。\n\n");
        prompt.append("要求：\n");
        prompt.append("1. 题目要贴合岗JD；\n");
        ...
        prompt.append("请生").append(questionCount).append(" 道题，题目类型包含：\n");
