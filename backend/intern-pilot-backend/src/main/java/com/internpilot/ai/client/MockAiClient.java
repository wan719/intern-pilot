...
public class MockAiClient implements AiClient {
    ...
    return """
        {
          ...
          "strengths": [
            "Spring Boot 项目经验与目标岗位高度匹",
            "MySQL、Redis、JWT RBAC 经验满足常见后端要求",
            "简历包含完整全栈项目及部署实践"
          ],
          "weaknesses": [
            "高并发生产经验仍然有",
          ...
          "suggestions": [
            "在项目部分补充可量化API、缓存和权限模块成果",
            "准备 Spring Security 过滤器链JWT 认证的具体案",
            "增加部署CI/CD 段落以强化工程完整
          ],
          "interviewTips": [
            "清晰解释 Spring Security 认证流程",
            "准备 Redis 缓存穿透、击穿和雪崩的解决方",
            "InternPilot 为主要项目故事，描述自己的职责分
          ]
        }
        """;
  }
  ...
  private String mockResumeOptimization() {
    return """
        ...
        项目经历
        --------
        InternPilot - AI 实习投递平| 全栈开
        2025.03 - 至今
        - 基于 Spring Boot + Vue3 构建 AI 驱动的实习投递平
        - 设计并实RBAC 权限管理系统，支持角权限动态绑
        - 集成 JWT 无状态认证，实现登录拦截Token 刷新
        - 使用 Redis 缓存 AI 分析结果，减少重API 调用
        - 通过 WebSocket 实时推AI 分析任务进度
        - 实现简历解析、岗位匹配、面试题生成AI 功能

        技能亮
        --------
        - 熟悉 Spring Boot 自动配置原理和常Starter
        - 理解 MySQL InnoDB 索引结构SQL 优化
        - 掌握 Redis 缓存策略和常见问题解决方
          ...
          "questions": [
            {
              ...
              "difficulty": "MEDIUM",
              "question": "Spring Boot @Transactional 注解的原理是什么？什么情况下事务会失效？",
            ...
            },
            {
              ...
              "keywords": ["Redis", "缓存穿", "缓存击穿", "缓存雪崩"],
              "source": "根据岗位 Redis 技能要求生",
              "sortOrder": 2
            },
            {
              ...
              "keywords": ["JWT", "认证", "安全"],
              "source": "根据岗位 Spring Security 技能要求生",
              "sortOrder": 3
            },
            {
              "questionType": "PROJECT",
              "difficulty": "MEDIUM",
              "question": "请详细介绍你InternPilot 项目中负责的模块和技术难点",
              "answer": "建议RBAC 权限设计、AI 分析流程、缓存策略等方面展开，重点说明自己独立完成的部分和遇到的挑战",
              "answerPoints": [
                "RBAC 权限模型设计",
                "AI 分析异步任务流程",
                "Redis 缓存策略",
            ...
            },
            {
              "questionType": "MYSQL",
              "difficulty": "MEDIUM",
              "question": "MySQL 中索引的底层数据结构是什么？为什么使B+ 树？",
              "answer": "InnoDB 使用 B+ 树作为索引结构。B+ 树所有数据存储在叶子节点，非叶子节点只存键值，适合范围查询和磁IO 优化",
              "answerPoints": [
                "B+ 树结构特",
                "叶子节点形成有序链表",
                "适合磁盘预读",
              ...
              "relatedSkills": ["MySQL", "索引", "B+],
              "followUps": [
                "聚簇索引和非聚簇索引的区别？",
                "什么情况下索引会失效？"
              ],
              "keywords": ["MySQL", "索引", "B+],
              "source": "根据岗位 MySQL 技能要求生",
              "sortOrder": 5
            },
            {
              "questionType": "JAVA_BASIC",
              "difficulty": "EASY",
              "question": "Java HashMap 的底层实现原理是什么？",
              "answer": "JDK 8 HashMap 采用数组+链表+红黑树实现。通过 hash 计算索引，冲突时用链表法，链表长度超8 且数组长>= 64 时转为红黑树",
              "answerPoints": [
                "数组+链表+红黑树结",
                "hash 冲突解决",
                "链表转红黑树条件",
            ...
            },
            {
              ...
              "relatedSkills": ["沟通表", "职业规划"],
              "followUps": [
                "你未3 年的职业规划是什么？",
                "如果实习期间遇到不熟悉的技术怎么办？"
              ],
              "keywords": ["HR面试", "职业规划", "沟],
              "source": "HR 面试常见问题",
              "sortOrder": 7
            },
            {
              ...
              "relatedSkills": ["高并", "Redis", "消息队列", "系统设计"],
              "followUps": [
          ...
          "recommendations": [
            {
              ...
              "companyName": "星云科技",
              "matchScore": 85,
              "reason": "Spring Boot RBAC 项目经验与岗位高度匹配
            },
            {
              "jobTitle": "AI 应用开发实习生",
              "companyName": "阿斯AI",
              "matchScore": 78,
              "reason": "AI 分析流程Prompt 工程经验相关
            },
            {
              "jobTitle": "全栈开发实习生",
              "companyName": "云桥科技",
              "matchScore": 72,
              "reason": "Vue Spring Boot 技术栈合适，但生产部署经验可以扩展
            }
          ]
        }
        """;
  ...
  private String mockRagQa() {
    return "根据知识库内容，Spring Boot、MyBatis、Redis JWT 是后端实习面试的常见话题。建议准备基于项目的示例和技术权衡的解释";
  }
