package com.internpilot.controller.application;
...
public class ApplicationController {
    ...
    @Operation(summary = "创建投递记", description = "为当前用户的某个岗位创建投递记")
    @OperationLog(module = "投递记", operation = "创建投递记", type = OperationTypeEnum.CREATE)
    ...
    @Operation(summary = "查询投递记录列", description = "分页查询当前用户的投递记")
    ...
    @Operation(summary = "查询投递记录详", description = "查询当前用户某条投递记录详")
    @PreAuthorize("hasAuthority('application:read')")
    @GetMapping("/{id}")
    ...
    @Operation(summary = "修改投递状", description = "修改当前用户某条投递记录的状")
    @OperationLog(module = "投递记", operation = "修改投递状", type = OperationTypeEnum.UPDATE)
    @PreAuthorize("hasAuthority('application:write')")
    ...
    @Operation(summary = "修改投递备", description = "修改当前用户某条投递记录的备注、复盘和面试时间")
    @OperationLog(module = "投递记", operation = "修改投递备", type = OperationTypeEnum.UPDATE)
    @PreAuthorize("hasAuthority('application:write')")
    @PutMapping("/{id}/note")
    ...
    @Operation(summary = "删除投递记", description = "逻辑删除当前用户某条投递记")
    @OperationLog(module = "投递记", operation = "删除投递记", type = OperationTypeEnum.DELETE)
