...
public class AdminController {
    ...
    @OperationLog(module = "管理", operation = "禁用用户", type = OperationTypeEnum.DISABLE)
    ...
    @PreAuthorize("hasAuthority('user:update')")
    @OperationLog(module = "管理", operation = "启用用户", type = OperationTypeEnum.ENABLE)
    ...
    @PreAuthorize("hasAuthority('user:update')")
    @OperationLog(module = "管理", operation = "修改用户角色", type = OperationTypeEnum.GRANT)
    ...
    @OperationLog(module = "管理", operation = "修改角色权限", type = OperationTypeEnum.GRANT)
