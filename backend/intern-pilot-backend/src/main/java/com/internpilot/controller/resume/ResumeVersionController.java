...
public class ResumeVersionController {
    ...
    @Operation(summary = "创建简历版")
    @OperationLog(module = "简历版", operation = "创建简历版", type = OperationTypeEnum.CREATE)
    ...
    @Operation(summary = "修改简历版")
    @OperationLog(module = "简历版", operation = "修改简历版", type = OperationTypeEnum.UPDATE)
    @PreAuthorize("hasAuthority('resume:write')")
    ...
    @Operation(summary = "设置当前简历版")
    @OperationLog(module = "简历版", operation = "设置当前简历版", type = OperationTypeEnum.UPDATE)
    @PreAuthorize("hasAuthority('resume:write')")
    ...
    @Operation(summary = "删除简历版")
    @OperationLog(module = "简历版", operation = "删除简历版", type = OperationTypeEnum.DELETE)
