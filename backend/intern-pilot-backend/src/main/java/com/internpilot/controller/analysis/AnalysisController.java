...
public class AnalysisController {
    ...
    @Operation(summary = "查询分析报告列表", description = "分页查询当前用户的历AI 分析报告")
    ...
    @Operation(summary = "查询分析报告详情", description = "查询当前用户某份 AI 分析报告的完整内")
    ...
    @Operation(summary = "删除分析报告", description = "逻辑删除当前用户自己AI 分析报告")
