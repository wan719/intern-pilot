...
CREATE TABLE IF NOT EXISTS user (
    ...
    preferred_job_title VARCHAR(100) DEFAULT NULL,
...
-- =========================
-- Initial single administrator
-- The plaintext password is not stored in this repository.
-- Replace the BCrypt hash through a secure server-side reset when rotating it.
-- =========================
